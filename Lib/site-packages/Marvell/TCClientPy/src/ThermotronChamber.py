...
class ThermotronChamber(object):
    """
    ...
    def __init__(self, chamber_control_name, description=None, portNumber="8888", simulate=False):
        ...
        if self.simulate:
            ...
            try:
                ...
                raise Exception("Could not locate that chamber name. Check network connection and/or thermal chamber ip")
            except timeout as e:
                print("Failed to open a terminal to {}, connection timed out".format(chamber_control_name))
                raise Exception("Time out - Check network connection and/or thermal chamber ip")
