...
<script>
    ...
    $(document).ready(function() {
        ...
        if(window.location.hash == "#fail"){
			let failedRows = $("tr.danger");
			if(failedRows.length > 0){
				$([document.documentElement, document.body]).animate({
					scrollTop: failedRows[0].scrollIntoView()
				}, 2000);
			}
		}
    } );
...
class HTMLFileHandler(BaseFileHandler):
    ...
    def __init__(self, title, version, rename=False, *args, **kwargs):
        super(HTMLFileHandler, self).__init__(*args, **kwargs)
